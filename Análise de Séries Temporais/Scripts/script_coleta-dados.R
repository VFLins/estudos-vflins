...
setwd("~/dados") # mudar para caminho verdadeiro para funcionar
...
write.csv(dados, row.names =FALSE,
	"~/dados/dados.csv")# mudar para caminho verdadeiro para funcionar
write.csv(dadoslong, row.names =FALSE,
	"~/dados/dadoslong.csv")# mudar para caminho verdadeiro para funcionar
